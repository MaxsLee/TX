...
print("Load data...")
df_data_train = pd.read_csv(r'F:\WorkSpace\tpai\1\train2.txt',header = None ,sep=',',encoding='gbk')
X_train = df_data_train.drop(len(df_data_train.keys())-1,axis = 1)
print(np.array(X_train).shape)
y_train = df_data_train[len(df_data_train.keys())-1]
df_data_test = pd.read_csv(r'F:\WorkSpace\tpai\1\test_features_encode.txt',header = None,sep=',',encoding='gbk')
...
gbm = lgb.train(params,lgb_train,num_boost_round= 80,valid_sets=lgb_train)
